 ...
 * Note that the last moment when an ant was on the plank is t = 4 second, after that it falls 
 * imediately out of the plank. (i.e. We can say that at t = 4.0000000001, there is no ants on the 
 * plank).
 * 
 * Example 2:
 * 
 ...
 * Output: 5
 * Explanation: At t = 1 second, both ants will be at the same intial position but with different 
 * direction.
 * 
 * Example 5:
 * 
